...
<body>
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        <div class="container py-2 px-4">
            <a href="#" class="navbar-brand mb-0 h1">
                <img src="assets/images/logo-white.svg" alt="Brand logo" style="width: 40px;">
            </a>
        <!-- Navbar Toggler -->
        ...
        <!-- Top Menu -->
                    ...
                    <ul class="navbar-nav ms-md-auto">
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-github text-white"></i><small class="ms-2 text-white"> Github</small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-twitter text-white"></i><small class="ms-2 text-white"> Twitter</small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-slack text-white"></i><small class="ms-2 text-white"> Slack</small>
                            </a>
                        </li>
            ...
            <!-- DROPDOWN     -->
                        <li class="nav-item">
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li> <button class="dropdown-tem active bg-purple" type="button"><small>Latest (5.3.x)</small> <i class="bi-check"></i></button></li>
                                    ...
                                    <li><h6 class="dropdwon-header">Previous Releases</h6></li>
                                    ...
                                    <li><button class="dropdown-item" type="button"><small> v.2.3.2</small></button></li>
                ...
                <!-- Dropdown -->
                        ...
                        <!-- Brightness -->
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><button class="dropdown-item active bg-purple" type="button" ><small><i class="bi-brighness-high-fill me-2"></i> Light</small></button></li>
    ...
    <div id="footer" class="bg-light py-5">
        ...
        <div class="container py-5 px-4">
            ...
            <p class="text-center fw-700 ">Faiq Rizki Al Fatih/ 1204222069 </p>
        </div>
    </div>
